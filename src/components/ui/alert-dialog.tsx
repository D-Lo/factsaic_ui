...
const PrimitiveAction = DialogPrimitive.Close;
const PrimitiveCancel = DialogPrimitive.Close;

const AlertDialogAction = React.forwardRef<
  React.ElementRef<typeof PrimitiveAction>,
  React.ComponentPropsWithoutRef<typeof PrimitiveAction>
>(({ className, ...props }, ref) => (
  <PrimitiveAction
    ref={ref}
...
AlertDialogAction.displayName = PrimitiveAction?.displayName || "AlertDialogAction"

const AlertDialogCancel = React.forwardRef<
  React.ElementRef<typeof PrimitiveCancel>,
  React.ComponentPropsWithoutRef<typeof PrimitiveCancel>
>(({ className, ...props }, ref) => (
  <PrimitiveCancel
    ref={ref}
    className={cn(
...
AlertDialogCancel.displayName = PrimitiveCancel?.displayName || "AlertDialogCancel"
